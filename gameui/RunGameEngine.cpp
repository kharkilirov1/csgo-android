...
public:
	...
	virtual const char *GetPlayerName( int friendsID )
	{
		static char szName[64];
		return GetPlayerName( friendsID, szName, sizeof( szName ) );
	}

	virtual const char *GetPlayerFriendsName( int friendsID )
	{
		static char szName[64];
		return GetPlayerFriendsName( friendsID, szName, sizeof( szName ) );
	}
};
