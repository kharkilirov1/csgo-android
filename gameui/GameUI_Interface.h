...
public:
	...
	// CS:GO IGameUI additions - stubbed for the Android port
	...
	virtual void OnDemoTimeout( void ) {}
	...
	virtual bool UpdateSecondaryProgressBar( float progress, const wchar_t *desc ) { return false; }
