...
{
	GetClientModeCSNormal()->GetViewportAnimationController()->StartAnimationSequence("HealthRestored");
}
...
void CHudHealth::OnThink()
{
	...
	else if ( realHealth <= 25 )
	{
		...
		GetClientModeCSNormal()->GetViewportAnimationController()->StartAnimationSequence("HealthLow");
	}
	else if( realHealth < m_iHealth )
	{
		// took a hit
		GetClientModeCSNormal()->GetViewportAnimationController()->StartAnimationSequence("HealthTookDamage");
	}
