...
BEGIN_VS_SHADER( Water_DX80, 
		                        ...
		                        IShaderDynamicAPI* pShaderAPI, bool bBlendReflection )
	{
		...
		DYNAMIC_STATE
		{
			...
			BindTexture( SHADER_SAMPLER1, TEXTURE_BINDFLAGS_NONE, REFLECTTEXTURE, -1 );
			BindTexture( SHADER_SAMPLER2, TEXTURE_BINDFLAGS_NONE, NORMALMAP, BUMPFRAME );
			pShaderAPI->BindStandardTexture( SHADER_SAMPLER3, TEXTURE_BINDFLAGS_NONE, TEXTURE_NORMALIZATION_CUBEMAP );
		                        ...
		                        IShaderDynamicAPI* pShaderAPI )
	{
		...
		DYNAMIC_STATE
		{
			...
			BindTexture( SHADER_SAMPLER0, TEXTURE_BINDFLAGS_NONE, BUMPMAP, BUMPFRAME );
			BindTexture( SHADER_SAMPLER1, TEXTURE_BINDFLAGS_NONE, REFRACTTEXTURE );
		                        ...
		                        IShaderDynamicAPI* pShaderAPI )
	{
		...
		DYNAMIC_STATE
		{
			...
			BindTexture( SHADER_SAMPLER1, TEXTURE_BINDFLAGS_NONE, REFRACTTEXTURE );
			BindTexture( SHADER_SAMPLER2, TEXTURE_BINDFLAGS_NONE, NORMALMAP, BUMPFRAME );
			s_pShaderAPI->BindStandardTexture( SHADER_SAMPLER3, TEXTURE_BINDFLAGS_NONE, TEXTURE_NORMALIZATION_CUBEMAP );
