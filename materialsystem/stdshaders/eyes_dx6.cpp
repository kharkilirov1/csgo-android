...
BEGIN_VS_SHADER( Eyes_dx6, 
	...
	void DrawFlashlight_Iris( IMaterialVar** params, IShaderDynamicAPI *pShaderAPI, IShaderShadow* pShaderShadow )
	{
		...
		DYNAMIC_STATE
		{
			...
			BindTexture( SHADER_SAMPLER0, TEXTURE_BINDFLAGS_NONE, FLASHLIGHTTEXTURE, FLASHLIGHTTEXTUREFRAME );

			BindTexture( SHADER_SAMPLER1, TEXTURE_BINDFLAGS_NONE, IRIS, IRISFRAME );
	...
	void DrawUsingSoftwareLighting( IMaterialVar** params, IShaderDynamicAPI *pShaderAPI, IShaderShadow* pShaderShadow )
	{
		...
		DYNAMIC_STATE
		{
			BindTexture( SHADER_SAMPLER0, TEXTURE_BINDFLAGS_NONE, IRIS, IRISFRAME );
		...
		DYNAMIC_STATE
		{
			BindTexture( SHADER_SAMPLER0, TEXTURE_BINDFLAGS_NONE, GLINT );
