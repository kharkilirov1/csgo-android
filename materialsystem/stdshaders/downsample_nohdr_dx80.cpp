...
BEGIN_VS_SHADER_FLAGS( Downsample_nohdr_DX80, "Help for Downsample_nohdr_DX80", SHADER_NOT_EDITABLE )
	...
	SHADER_DRAW
	{
		...
		DYNAMIC_STATE
		{
			...
			BindTexture( SHADER_SAMPLER1, TEXTURE_BINDFLAGS_NONE, BASETEXTURE, -1 );
			BindTexture( SHADER_SAMPLER2, TEXTURE_BINDFLAGS_NONE, BASETEXTURE, -1 );
			BindTexture( SHADER_SAMPLER3, TEXTURE_BINDFLAGS_NONE, BASETEXTURE, -1 );
