		...
		case kRenderTransAddFrameBlend:
			{
				...
				DYNAMIC_STATE
				{
					...
					BindTexture( SHADER_SAMPLER0, TEXTURE_BINDFLAGS_NONE, pTexture, ( int )flFrame );
				...
				DYNAMIC_STATE
				{
					...
					BindTexture( SHADER_SAMPLER0, TEXTURE_BINDFLAGS_NONE, pTexture, ( ( int )flFrame + 1 ) % numAnimationFrames );
