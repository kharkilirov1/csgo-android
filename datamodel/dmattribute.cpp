...
//-----------------------------------------------------------------------------
static bool Serialize( CUtlBuffer &buf, const DmElementHandle_t &src )
{
	Assert( 0 );
	return false;
}
...
template< class T >
static bool SerializeAttributeValue( CUtlBuffer &buf, const T &src )
{
	return ::Serialize( buf, src );
}

template<>
bool SerializeAttributeValue<DmElementHandle_t>( CUtlBuffer &, const DmElementHandle_t & )
{
	return false;
}

template<>
bool SerializeAttributeValue<CDmeUndoHandle>( CUtlBuffer &, const CDmeUndoHandle & )
{
	return false;
}

template<>
bool SerializeAttributeValue<DmUnknownAttribute_t>( CUtlBuffer &, const DmUnknownAttribute_t & )
{
	return false;
}
...
public:
	...
	virtual const char	*GetDesc()
	{
		...
		{
			SerializeAttributeValue( serialized, m_Value );
		}
