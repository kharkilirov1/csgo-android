...
#define DMXELEMENT_UNPACK_FIELD( _attributeName, _defaultString, _type, _varName )	\
	{ _attributeName, _defaultString, CDmAttributeInfo<_type>::AttributeType(), size_cast<int>( offsetof( DestStructType_t, _varName ) ), size_cast<int>( sizeof( ((DestStructType_t *)0)->_varName) ), NO_BIT_OFFSET, NOT_A_BITFIELD, NO_USER_DATA, NO_EMBEDDED_TYPENAME, NO_EMBEDDED_STRUCT_PTR, NOT_AN_ARRAY },
...
#define DMXELEMENT_UNPACK_FIELD_ARRAY( _attributeName, _defaultString, _type, _varName )	\
	{ _attributeName, _defaultString, CDmAttributeInfo< CUtlVector< _type > >::AttributeType(), size_cast<int>( offsetof( DestStructType_t, _varName ) ), size_cast<int>( sizeof( ((DestStructType_t *)0)->_varName[0]) ), NO_BIT_OFFSET, NOT_A_BITFIELD, NO_USER_DATA, NO_EMBEDDED_TYPENAME, NO_EMBEDDED_STRUCT_PTR, size_cast<int>( ARRAYSIZE( ((DestStructType_t *)0)->_varName ) ) },
