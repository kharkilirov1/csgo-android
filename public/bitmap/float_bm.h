...
{
	PixRGBA8 x;
	x.Red = std::max( 0.f, std::min( 255.f,255.f*f.Red ) );
	x.Green = std::max( 0.f, std::min( 255.f,255.f*f.Green ) );
	x.Blue = std::max( 0.f, std::min( 255.f,255.f*f.Blue ) );
	x.Alpha = std::max( 0.f, std::min( 255.f,255.f*f.Alpha ) );
	return x;
}
