...
public:
	...
	CDmElement*			Copy( TraversalDepth_t depth ) const;

	// Copies attributes from a specified element
	void				CopyAttributesTo( CDmElement *pCopy, TraversalDepth_t depth ) const;
	...
	int					EstimateMemoryUsage( TraversalDepth_t depth );
...
protected:
	...
	CDmElement*			CopyInternal( TraversalDepth_t depth ) const;
	...
	public:											\
		...
		{											\
			return m_classType;						\
													...
													\
		className* Copy( TraversalDepth_t depth ) const		\
		{																\
