...
{
#if defined( _WIN32 )
	static char s_szNetError[ 64 ];
	Q_snprintf( s_szNetError, sizeof( s_szNetError ), "socket error %d", code );
	return s_szNetError;
#else
...
// Force this TU to emit these templates' vtables and out-of-line members.
template class CryptoPP::AutoSeededX917RNG<CryptoPP::AES>;
template class CryptoPP::OAEP<CryptoPP::SHA1, CryptoPP::P1363_MGF1>;
template class CryptoPP::AlgorithmParametersTemplate<CryptoPP::ConstByteArrayParameter>;
template class CryptoPP::AlgorithmParametersTemplate<int>;
