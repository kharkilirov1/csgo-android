...
// CS:GO's tool headers still expose the legacy Spew callback signature even
// though the 2018 tier0 logging implementation no longer declares these
// enums. Keep the ABI values used by the old tools until cmdlib is migrated to
// LoggingSystem.
enum SpewType_t
{
	SPEW_MESSAGE = 0,
